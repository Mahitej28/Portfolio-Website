...
const About = () => {
  return (
    <div name='about' className='w-full bg-gradient-to-b from-cyan-900 to-black  text-white md:h-screen'>
       <div className=' max-w-screen-lg flex flex-col justify-center mx-auto pt-20 px-4 w-full h-full'>
        ...
        <br/>
        <p className='text-xl text-left'> Highly responsible and organized with excellent writing, communication, and critical thinking abilities.</p>
